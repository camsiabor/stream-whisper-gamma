...
from src.common.langutil import LANGUAGES
...
class GoogleNewTranslationError(Exception):
    ...
    def __init__(self, msg=None, **kwargs):
        ...
        if msg:
            ...
            self.msg = None
        super(GoogleNewTranslationError, self).__init__(self.msg)
...
class GoogleTranslator:
    ...
    def translate(self, text, lang_des='auto', lang_src='auto', pronounce=False):
        try:
            lang = LANGUAGES[lang_src]
        except:
            lang_src = 'auto'
        try:
            lang = LANGUAGES[lang_des]
        except:
            lang_src = 'auto'
        text = str(text)
        if len(text) >= 5000:
        ...
        freq = self._package_rpc(text, lang_src, lang_des)
        ...
        try:
            ...
            raise GoogleNewTranslationError(tts=self, response=r)
        except requests.exceptions.RequestException as e:
            # Request failed
            raise GoogleNewTranslationError(tts=self)
